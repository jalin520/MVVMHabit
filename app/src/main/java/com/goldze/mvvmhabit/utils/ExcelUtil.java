...
public class ExcelUtil {
     ...
     * @param filename Excel表格文件名 demo.xls
     * @param colName  excel中包含的列名（可以有多个）
     */
    public void initExcel(String filePath, String filename, String[] colName) {
        format();
    ...
    public <T> void writeObjListToExcel(List<T> objList, String fileName) {
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(String.valueOf(demoBean.getSex()));
